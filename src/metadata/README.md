 ...
 * [ogms.yml](ogms.yml)
     * Determines how your purl.obolibrary.org/obo/ogms/ redirects will be handled
     ...
     * Paste in the contents of [ogms.yml](ogms.yml)
 ...
 * [ogms.md](ogms.md)
     ...
     * Paste in the contents of [ogms.md](ogms.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
